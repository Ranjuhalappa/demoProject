...
import com.adobe.aem.guides.wknd.core.models.AppConstantScheduler;
import com.adobe.aem.guides.wknd.core.models.EmailService;
import com.adobe.aem.guides.wknd.core.models.ResourceResolverService;
import com.adobe.aem.guides.wknd.core.models.WorkflowStatusConfiguration;
...
@Component(immediate = true, service = Runnable.class, property = {
        Constants.SERVICE_ID + AppConstantScheduler.EQUALS + WorkflowStatusScheduler.NAME
})
...
public class WorkflowStatusScheduler implements Runnable {
        ...
        try {
            ...
            for (Workflow workflow : workflows) {
                workflowDetails
                        ...
                        .append(AppConstantScheduler.NEW_LINE)
                        .append("Payload: ")
    ...
    public void run() {
        ...
        String content = "Hi, " + AppConstantScheduler.NEW_LINE + "Following is the workflow status at: "
                + LocalDateTime.now() + AppConstantScheduler.NEW_LINE
                + workflowStatus;
        // Send emails
