...
public class Datasource extends WCMUsePojo {
    ...
    public void activate() throws Exception {
        ...
        try {
            ...
            String dataPath = ResourceUtil.getValueMap(getResource().getChild("datasource")).get("data_path",
                    String.class);

            log.info("Data path is: {}", dataPath);

            Resource resource = resolver.getResource(DataConstants.DATASOURCE_PATH + dataPath);
