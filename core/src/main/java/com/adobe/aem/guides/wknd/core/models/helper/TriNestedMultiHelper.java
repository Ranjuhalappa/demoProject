...
public class TriNestedMultiHelper {
    ...
    public List<TriNestedHelperClass> myUserSub;

    public List<TriNestedHelperClass> getMyUserSub() {
        return myUserSub;
    }

    public void setMyUserSub(List<TriNestedHelperClass> myUserSub) {
        this.myUserSub = myUserSub;
    }

    public TriNestedMultiHelper(Resource resource) {
        try {
