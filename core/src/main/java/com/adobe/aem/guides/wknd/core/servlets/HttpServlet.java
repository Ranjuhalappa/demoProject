...
import com.adobe.aem.guides.wknd.core.models.HttpService;
 ...
 * 
 *         This method makes an HTTP call and read the value from the JSON
 *         webservice via an OSGi configuration
 *
 */
