...
public class CFSling {
    ...
    public static final String CF_PATH = "/content/dam/wknd/cf-sling-/cf-sling";
    ...
    public String getSubTitle() {
        ...
        return contentFragment.map(cf -> cf.getElement("subTitle")).map(ContentElement::getContent)
                .orElse(StringUtils.EMPTY);
    }
    ...
    public String getDate() {
        ...
        return (contentFragment.map(cf -> cf.getElement("date")).map(ContentElement::getContent)
                .orElse(StringUtils.EMPTY));
    }
}