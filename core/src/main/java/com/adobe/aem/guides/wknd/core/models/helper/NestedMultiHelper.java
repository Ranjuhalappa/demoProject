...
public class NestedMultiHelper {
    ...
    public List<NestedHelperClass> myUserSub;

    public List<NestedHelperClass> getMyUserSub() {
        return myUserSub;
    }

    public void setMyUserSub(List<NestedHelperClass> myUserSub) {
        this.myUserSub = myUserSub;
    }

    public NestedMultiHelper(Resource resource) {
        try {
